...
_Note: see [Create Databases](https://ibm-client-engineering.github.io/solution-filenet-aws/Create/Deploy/solution-deploy-postgres#create-the-databases) for the tablespaces configuration, including their names._
5. Under _Workflow System Security Groups_ ->_Administration Group_, enter the admin group you want to assign to the Workflow System. These two can be found in your filenet configuration within the CR. &emsp;&emsp; _Note: see [Deploying CR](https://ibm-client-engineering.github.io/solution-filenet-aws/Create/Deploy/solution-deploy-operator#deploying-cr). The admin group is specified under_ `initialize_configuration: ic_ldap_admins_groups_name` in the CR.
...
_Note:_ If you are importing a key again, you may encounter the following error:
...
```bash
path-to-java-home/bin/keytool -delete -keystore path-to-java-home/lib/security/cacerts -alias mykey
```
