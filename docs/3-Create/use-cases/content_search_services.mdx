...
- [Enable CSS](https://ibm-client-engineering.github.io/solution-filenet-aws/Create/Deploy/solution-deploy-operator#enabling-content-search-services) through the CR. 
