...
:::note
There are extra tasks to perform once the CR is applied to the running operator in order to fully support IER deployment. See below in Appendix under Task Manager Extra Tasks.
:::
