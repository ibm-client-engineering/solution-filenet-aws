...
[Create the following objects stores](https://ibm-client-engineering.github.io/solution-filenet-aws/Create/Deploy/solution-deploy-operator#adding-object-stores) and configure them as mentioned. These are the prerequisite for IER Functaionality to work correctly.

1. ROS - Object Store 

      [Configure connection points](https://ibm-client-engineering.github.io/solution-filenet-aws/Create/Deploy/solution-deploy-workflow#creating-a-workflow-system-and-connection-point-within-filenet) for ROS. Below is a screenshot for reference 
...
- Enter the task manager url
  ...
  - e.g. - http or https  _://ServerName/Portnumber/taskManagerWeb/api/V1._
