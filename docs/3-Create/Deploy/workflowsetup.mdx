...
See [Create Databases](https://ibm-client-engineering.github.io/solution-filenet-aws/Create/Deploy/solution-deploy-postgres#create-the-databases) for the tablespaces configuration, including their names.
...
See [Deploying CR](https://ibm-client-engineering.github.io/solution-filenet-aws/Create/Deploy/solution-deploy-operator#deploying-cr). The admin group is specified under `initialize_configuration: ic_ldap_admins_groups_name` in the CR.
...
#### Prerequisites
- Workflow system and connection point have been [created](https://ibm-client-engineering.github.io/solution-filenet-aws/Create/use-cases/solution-filenet-workflow#creating-a-workflow-system-and-connection-point-within-filenet) via the acce console in Object Store X (OSX)
