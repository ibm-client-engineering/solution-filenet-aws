...
caseName="ibm-cp-fncm-case"
inventory="fncmOperatorSetup"

caseCatalogName="ibm-fncm-operator-catalog"
channelName="v22.1"
...
uninstall_operator_native() {
    ...
    # - dependent resources
#    $kubernetesCLI delete -n "${namespace}" "${couchDeployment}" --ignore-not-found=true
}
delete_custom_resources() {
        echo "-------------Deleting custom resources-------------"
    local cr="${casePath}"/inventory/"${inventory}"/files/op-cli/fncm_v1_fncm_cr.yaml
